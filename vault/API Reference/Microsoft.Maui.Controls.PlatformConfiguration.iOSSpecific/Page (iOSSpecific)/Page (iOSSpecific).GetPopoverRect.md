---
title: "Page (iOSSpecific).GetPopoverRect"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Controls-PlatformConfiguration-iOSSpecific
aliases:
  - "Microsoft.Maui.Controls.PlatformConfiguration.iOSSpecific.Page.GetPopoverRect"
declaring_type: "Page (iOSSpecific)"
member_kind: method
---

# Page (iOSSpecific).GetPopoverRect
...
```csharp
System.Drawing.Rectangle static GetPopoverRect(Microsoft.Maui.Controls.BindableObject element)
```
