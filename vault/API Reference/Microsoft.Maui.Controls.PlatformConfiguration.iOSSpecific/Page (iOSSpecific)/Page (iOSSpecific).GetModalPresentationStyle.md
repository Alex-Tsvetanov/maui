---
title: "Page (iOSSpecific).GetModalPresentationStyle"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Controls-PlatformConfiguration-iOSSpecific
aliases:
  - "Microsoft.Maui.Controls.PlatformConfiguration.iOSSpecific.Page.GetModalPresentationStyle"
declaring_type: "Page (iOSSpecific)"
member_kind: method
---

# Page (iOSSpecific).GetModalPresentationStyle
...
```csharp
Microsoft.Maui.Controls.PlatformConfiguration.iOSSpecific.UIModalPresentationStyle static GetModalPresentationStyle(Microsoft.Maui.Controls.BindableObject element)
```
...
|---|---|
| `element` | The `BindableObject` whose modal presentation style is being retrieved. |
