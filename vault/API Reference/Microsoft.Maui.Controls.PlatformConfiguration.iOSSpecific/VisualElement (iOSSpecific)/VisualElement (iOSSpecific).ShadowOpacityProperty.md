---
title: "VisualElement (iOSSpecific).ShadowOpacityProperty"
tags:
  - api
  - member/field
  - ns/Microsoft-Maui-Controls-PlatformConfiguration-iOSSpecific
aliases:
  - "Microsoft.Maui.Controls.PlatformConfiguration.iOSSpecific.VisualElement.ShadowOpacityProperty"
declaring_type: "VisualElement (iOSSpecific)"
member_kind: field
---

# VisualElement (iOSSpecific).ShadowOpacityProperty

> [!abstract] Field of [[VisualElement (iOSSpecific)|VisualElement (iOSSpecific)]]
...
```csharp
Microsoft.Maui.Controls.BindableProperty static readonly ShadowOpacityProperty
```
