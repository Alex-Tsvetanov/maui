---
title: "ViewHandler.MapWidth"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Handlers
aliases:
  - "Microsoft.Maui.Handlers.ViewHandler.MapWidth"
declaring_type: "ViewHandler"
member_kind: method
---

# ViewHandler.MapWidth
...
```csharp
void static MapWidth(Microsoft.Maui.IViewHandler! handler, Microsoft.Maui.IView! view)
```
