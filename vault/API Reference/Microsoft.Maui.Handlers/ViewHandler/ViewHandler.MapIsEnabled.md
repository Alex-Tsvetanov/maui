---
title: "ViewHandler.MapIsEnabled"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Handlers
aliases:
  - "Microsoft.Maui.Handlers.ViewHandler.MapIsEnabled"
...
```csharp
void static MapIsEnabled(Microsoft.Maui.IViewHandler! handler, Microsoft.Maui.IView! view)
```
