---
title: "ViewHandler.MapShadow"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Handlers
aliases:
  - "Microsoft.Maui.Handlers.ViewHandler.MapShadow"
declaring_type: "ViewHandler"
member_kind: method
---

# ViewHandler.MapShadow
...
```csharp
void static MapShadow(Microsoft.Maui.IViewHandler! handler, Microsoft.Maui.IView! view)
```
