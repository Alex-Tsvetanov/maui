---
title: "ViewHandler.MapBorderView"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Handlers
aliases:
  - "Microsoft.Maui.Handlers.ViewHandler.MapBorderView"
declaring_type: "ViewHandler"
member_kind: method
---

# ViewHandler.MapBorderView
...
```csharp
void static MapBorderView(Microsoft.Maui.IViewHandler! handler, Microsoft.Maui.IView! view)
```
