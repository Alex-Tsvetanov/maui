---
title: "BlazorWebView (WindowsForms).Dispose"
tags:
  - api
  - member/method
  - ns/Microsoft-AspNetCore-Components-WebView-WindowsForms
aliases:
  - "Microsoft.AspNetCore.Components.WebView.WindowsForms.BlazorWebView.Dispose"
declaring_type: "BlazorWebView (WindowsForms)"
member_kind: method
---

# BlazorWebView (WindowsForms).Dispose
...
```csharp
void override Dispose(bool disposing)
```
