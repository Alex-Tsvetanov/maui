---
title: "BindableProperty.CreateAttached"
tags:
  - api
  - member/method
  - ns/Microsoft-Maui-Controls
aliases:
  - "Microsoft.Maui.Controls.BindableProperty.CreateAttached"
...
When using the `propertyChanged` callback, note that if multiple attached `BindableProperty` instances share the same `BindingPropertyChangedDelegate`, the callback cannot determine which specific property triggered the change. Consider using separate callback methods for properties that require different handling.
