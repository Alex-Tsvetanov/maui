...
tags:
  ...
  - area/ios
ms_date: "04/22/2025"
source: "https://learn.microsoft.com/dotnet/maui/ios/pair-to-mac?view=net-maui-10.0"
---
...
1. Enable **Remote Login** in the **Advanced** list.
    ...
    ![](media/pair-to-mac/remote-login-setting.png)
...
1. Click on the **i** next to the Remote Login setting to configure more settings:
    ...
    ![](media/pair-to-mac/remote-login-advanced-settings.png)
...
1. Open the **Pair to Mac** dialog with the **Pair to Mac** button iOS toolbar:
    ...
    ![](media/pair-to-mac/ios-toolbar.png)
    ...
    ![](media/pair-to-mac/pairtomac.png)
...
1. Examine the connection status icon. When Visual Studio 2022 is connected to a Mac, that Mac's item in the **Pair to Mac** dialog displays an icon indicating that it's currently connected:
    ...
    ![](media/pair-to-mac/connected.png)
    ...
    >
    > ![](media/pair-to-mac/contextmenu.png)
    >
...
1. Open **System Preferences > Sharing > Remote Login** on your Mac to locate your Mac’s IP address:
    ...
    ![](media/pair-to-mac/remote-login.png)
...
1. In Visual Studio 2022's **Pair to Mac** dialog, select **Add Mac...**:
    ...
    ![](media/pair-to-mac/addtomac.png)

1. Enter the Mac's IP address and select **Add**:

    ![](media/pair-to-mac/enteripaddress.png)
...
![](media/pair-to-mac/enable-auto-connection.png)
...
For more information about building iOS apps from the Windows command-line, see [[publish-cli|Publish an iOS app using the command line]].
