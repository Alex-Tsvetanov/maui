...
tags:
  ...
  - area/ios
ms_date: "04/05/2022"
source: "https://learn.microsoft.com/dotnet/maui/ios/platform-specifics/slider-thumb?view=net-maui-10.0"
---

# Slider thumb tap on iOS

This .NET Multi-platform App UI (.NET MAUI) iOS platform-specific enables the `Slider.Value` property to be set by tapping on a position on the [[Slider (Controls)|Slider]] bar, rather than by having to drag the [[Slider (Controls)|Slider]] thumb. It's consumed in XAML by setting the `Slider.UpdateOnTap` bindable property to `true`:
