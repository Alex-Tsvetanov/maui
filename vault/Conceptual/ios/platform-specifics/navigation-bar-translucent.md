...
tags:
  ...
  - area/ios
ms_date: "04/05/2022"
source: "https://learn.microsoft.com/dotnet/maui/ios/platform-specifics/navigation-bar-translucent?view=net-maui-10.0"
---

# NavigationPage bar translucency on iOS

This .NET Multi-platform App UI (.NET MAUI) iOS platform-specific is used to change the transparency of the navigation bar on a [[NavigationPage (Controls)|NavigationPage]], and is consumed in XAML by setting the `NavigationPage.IsNavigationBarTranslucent` attached property to a `boolean` value:
...
![](media/navigation-bar-translucent/translucent-navigation-bar.png)
