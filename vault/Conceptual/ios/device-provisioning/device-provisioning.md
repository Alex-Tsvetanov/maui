...
tags:
  ...
  - area/ios
ms_date: "11/28/2022"
source: "https://learn.microsoft.com/dotnet/maui/ios/device-provisioning?view=net-maui-10.0"
---
...
- **Automatically**. Signing identities, App IDs, and provisioning profiles will be automatically created and managed by Visual Studio. This is the recommended approach for provisioning an iOS device. For more information, see [[automatic-provisioning|Automatic provisioning]].
- **Manually**. Signing identities, App IDs, and provisioning profiles will be created and managed in your [Apple Developer Account](https://developer.apple.com/account). For more information, see [[manual-provisioning|Manual provisioning]].
