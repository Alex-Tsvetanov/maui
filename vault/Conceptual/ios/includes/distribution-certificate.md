...
tags:
  ...
  - area/ios
ms_date: "08/28/2024"
source: "https://learn.microsoft.com/dotnet/maui/ios/includes/distribution-certificate?view=net-maui-10.0"
---

## Create a distribution certificate

A distribution certificate is used to confirm your identity. Before creating a distribution certificate, you should ensure that you've added your Apple Developer Account to Visual Studio. For more information, see [[apple-account-management|Apple account management]].
