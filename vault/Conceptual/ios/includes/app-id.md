...
tags:
  ...
  - area/ios
ms_date: "11/30/2022"
source: "https://learn.microsoft.com/dotnet/maui/ios/includes/app-id?view=net-maui-10.0"
---
...
1. On the **Register a new identifier** page, select **App** before clicking the **Continue** button:
    ...
    ![](../deployment/media/publish/register-identifier.png)
