...
tags:
  ...
  - area/ios
ms_date: "02/11/2026"
source: "https://learn.microsoft.com/dotnet/maui/ios/objective-sharpie/platform/api-definition-structs-enums?view=net-maui-10.0"
---
...
(such as those flagged with a [[verify|`Verify` attribute]]).
...
See [[ios-binding-projects|iOS binding projects]]
to see how these files fit into the binding process, as shown in the diagram below:

![The binding process is shown in this diagram](api-definition-structs-enums-images/binding-flowchart.png)

Refer to the `ObjCRuntime` namespace API reference
