...
tags:
  ...
  - area/ai
ms_date: "03/11/2026"
source: "https://learn.microsoft.com/dotnet/maui/ai/embeddings?view=net-maui-10.0"
---

# Text embeddings

This page shows how to use [`IEmbeddingGenerator<string, Embedding<float>>`](/dotnet/ai/iembeddinggenerator) in a .NET MAUI app once services are registered. For setup and registration, see [[getting-started|Get started]]. For platform requirements, see [[requirements-apple|Requirements]].
