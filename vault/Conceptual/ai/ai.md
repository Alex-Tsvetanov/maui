...
tags:
  ...
  - area/ai
ms_date: "03/11/2026"
source: "https://learn.microsoft.com/dotnet/maui/ai?view=net-maui-10.0"
---
...
| Article | Description |
|---------|-------------|
| [[getting-started|Get started]] | Install the package and register the chat client and embedding generator services. |
| [[chat|Chat]] | Use `IChatClient` for basic chat, streaming, multi-turn conversations, tool calling, and structured output. |
| [[embeddings|Text embeddings]] | Use `IEmbeddingGenerator` to generate on-device text embeddings for semantic search and similarity. |
| [[agent-framework|Agent framework integration]] | Build multi-agent AI workflows with Microsoft.Agents.AI and Microsoft.Maui.Essentials.AI. |
| [[feature-comparison|Feature comparison]] | Feature availability across all platforms. |
| [[requirements-apple|Requirements]] | Supported OS versions and device requirements for iOS, macOS, Mac Catalyst, and tvOS. |
