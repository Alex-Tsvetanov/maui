...
tags:
  ...
  - area/ai
ms_date: "03/11/2026"
source: "https://learn.microsoft.com/dotnet/maui/ai/getting-started?view=net-maui-10.0"
---

# Get started with Microsoft.Maui.Essentials.AI

This page covers installation and service registration. Once services are registered, see [[chat|Chat]] and [[embeddings|Text embeddings]] for usage examples.
...
- [[chat|Chat]] — use `IChatClient` for conversational AI, tool calling, and structured output
- [[embeddings|Text embeddings]] — use `IEmbeddingGenerator` for semantic search and similarity
- [[requirements-apple|Requirements]] — supported OS versions and device requirements
