...
tags:
  ...
  - area/fundamentals
ms_date: "02/27/2025"
source: "https://learn.microsoft.com/dotnet/maui/fundamentals/data-binding?view=net-maui-10.0"
---
...
Data binding is therefore the technique of linking properties of two objects so that changes in one property are automatically reflected in the other property. One of the two objects involved in a data binding is almost always an element that derives from [[View|View]] and forms part of the visual interface of a page. The other object is either:

- Another [[View|View]] derivative, usually on the same page.
- An object in a code file.

Data bindings between two [[View|View]] derivatives are often shown in these articles, for purposes of clarity and simplicity. However, the same principles can be applied to data bindings between a [[View|View]] and other objects. When an application is built using the Model-View-ViewModel (MVVM) architecture, the class with underlying data is often called a viewmodel.
