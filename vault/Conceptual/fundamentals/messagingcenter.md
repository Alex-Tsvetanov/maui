...
tags:
  ...
  - area/fundamentals
ms_date: "08/18/2025"
source: "https://learn.microsoft.com/dotnet/maui/fundamentals/messagingcenter?view=net-maui-10.0"
---
...
- Regular .NET events for local communication, ideally with [[WeakEventManager|WeakEventManager]] to avoid memory leaks.
...
For simple, local communication (for example, between a control and its parent), standard .NET events are often sufficient. To reduce the risk of memory leaks with long-lived publishers, use [[WeakEventManager|WeakEventManager]]:
...
![](media/messagingcenter/messagingcenter.png)
