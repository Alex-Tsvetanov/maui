...
tags:
  ...
  - area/tutorials
ms_date: "03/21/2024"
source: "https://learn.microsoft.com/dotnet/maui/tutorials/notes-mvvm?view=net-maui-10.0"
---

# Upgrade your app with MVVM concepts

This tutorial is designed to continue the [[notes-app|Create a .NET MAUI app]] tutorial, which created a note taking app. In this tutorial, you'll learn how to:
...
We suggest that you first follow the [[notes-app|Create a .NET MAUI app]] tutorial, as the code created in that tutorial is the basis for this tutorial. If you lost the code, or want to start fresh, download [this project](https://github.com/dotnet/maui-samples/raw/main/9.0/Tutorials/ConvertToMvvm/app_before.zip).
...
![](./media/notes-mvvm/mvvm/mvvm-pattern.png)
...
01. Next, select **Install** and accept any prompts that are displayed.
    ...
    ![](./media/notes-mvvm/viewmodel-about/nuget.png)
...
![](./media/notes-mvvm/viewmodel-about/class-structure-1.png)
...
01. Next, add the `ApplyQueryAttributes` method to the class, which satisfies the requirements of the [[IQueryAttributable|IQueryAttributable]] interface:
...
- [[navigation#process-navigation-data-using-a-single-method|ApplyQueryAttributes - Process navigation data using a single method]]
