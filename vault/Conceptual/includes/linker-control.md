---
title: "Linker Control"
tags:
  - conceptual
  - area/includes
ms_date: "05/23/2023"
source: "https://learn.microsoft.com/dotnet/maui/includes/linker-control?view=net-maui-10.0"
---
...
The attribute specifies the member to keep via a `string` or via the `DynamicallyAccessedMembers` attribute. The type and assembly are either implicit in the attribute context, or explicitly specified in the attribute (by `Type`, or by `string`s for the type and assembly name).
