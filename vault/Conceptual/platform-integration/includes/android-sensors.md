...
ms_date: "11/08/2023"
source: "https://learn.microsoft.com/dotnet/maui/platform-integration/includes/android-sensors?view=net-maui-10.0"
---

<!-- markdownlint-disable MD025 -->
# [Android](#tab/android)

If your app targets Android 12+ (API 31+), the system places a 200 Hz limit on the refresh rate of data from this sensor. If your app needs to gather sensor data using the [[SensorSpeed.Fastest|Fastest]] sensor speed, you must declare the `HIGH_SAMPLING_RATE_SENSORS` permission. You can configure the permission in the following ways:
