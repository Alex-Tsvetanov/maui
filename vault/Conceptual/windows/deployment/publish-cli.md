...
tags:
  ...
  - area/windows
ms_date: "02/24/2026"
source: "https://learn.microsoft.com/dotnet/maui/windows/deployment/publish-cli?view=net-maui-10.0"
---
...
> - [[publish-visual-studio-folder|Publish a packaged app using Visual Studio]]
...
![](media/publish-cli/install-untrusted.png)
...
01. Choose the certificate then press **Details**.
    ...
    ![](media/publish-cli/properties-digital-signatures.png)
...
![](media/publish-cli/install-trusted.png)
