...
tags:
  ...
  - area/data-cloud
ms_date: "11/10/2025"
source: "https://learn.microsoft.com/dotnet/maui/data-cloud/aspire-integration?view=net-maui-10.0"
---
...
For more information about the traditional approach, see [[local-web-services|Connect to local web services]].
...
![](media/aspire-integration/maui-aspire-project-structure.png)
...
![](media/aspire-integration/maui-aspire-windows-android.png)
...
![](media/aspire-integration/maui-aspire-app-resources-dashboard.png)
...
![](media/aspire-integration/maui-aspire-http-trace.png)
...
- [[local-web-services|Connect to local web services (traditional approach)]]



.NET MAUI integration with Aspire is available in .NET MAUI 10 and later. For information about connecting to local web services in earlier versions, see [[local-web-services|Connect to local web services]].
