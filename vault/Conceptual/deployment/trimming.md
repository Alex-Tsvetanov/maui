...
tags:
  ...
  - area/deployment
ms_date: "12/20/2024"
source: "https://learn.microsoft.com/dotnet/maui/deployment/trimming?view=net-maui-10.0"
---
...
> [!IMPORTANT]
> Don't set the `$(TrimMode)` build property when using Native AOT deployment, which automatically performs full trimming of your app. For more information, see [[nativeaot|Native AOT deployment on iOS and Mac Catalyst]].
