...
tags:
  ...
  - area/deployment
ms_date: "09/17/2024"
source: "https://learn.microsoft.com/dotnet/maui/deployment/visual-studio-properties?view=net-maui-10.0"
---

# Project configuration for .NET MAUI apps

.NET MAUI uses a [[single-project|single-project system]] to manage the configuration of your cross-platform app. Project configuration in .NET MAUI is similar to other projects in Visual Studio, right-click on the project in the **Solution Explorer**, and select **Properties**.
...
- **Custom Entitlements**
  ...
  The plist file to use for entitlements. For more information, see [[entitlements|Entitlements]].
