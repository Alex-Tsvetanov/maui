...
tags:
  ...
  - area/deployment
ms_date: "03/09/2026"
source: "https://learn.microsoft.com/dotnet/maui/deployment/runtimes-compilation?view=net-maui-10.0"
---
...
When you publish with [[nativeaot|Native AOT]], your app doesn't run on Mono or CoreCLR. Instead, it runs on a minimal NativeAOT runtime that's statically linked into your native binary. This runtime includes a garbage collector and type system but no JIT compiler — all code is compiled to native machine code at build time.
...
For more information, see [[nativeaot|Native AOT deployment on iOS and Mac Catalyst]] and [Native AOT deployment](/dotnet/core/deploying/native-aot).
...
For more information, see [[interpreter|Mono interpreter on iOS and Mac Catalyst]].
...
For more information, see [[trimming|Trim a .NET MAUI app]].
...
- [[nativeaot|Native AOT deployment on iOS and Mac Catalyst]]
- [[interpreter|Mono interpreter on iOS and Mac Catalyst]]
