...
tags:
  ...
  - area/general
ms_date: "06/21/2024"
source: "https://learn.microsoft.com/dotnet/maui/what-is-maui?view=net-maui-10.0"
---
...
![](media/what-is-maui/maui-overview.png)
...
![](media/what-is-maui/architecture-diagram.png)
...
.NET MAUI single project is enabled using multi-targeting and the use of SDK-style projects. For more information about .NET MAUI single project, see [[single-project|.NET MAUI single project]].
