...
tags:
  ...
  - area/android
ms_date: "08/30/2024"
source: "https://learn.microsoft.com/dotnet/maui/android/manifest?view=net-maui-10.0"
---
...
All .NET MAUI apps have a `MainActivity` class that derives from `Activity`, via the `MauiAppCompatActivity` class, and that has the `ActivityAttribute` applied to it. Some apps may include additional classes that derive from `Activity` and that have the `ActivityAttribute` applied.
...
| --------- | ----------- |
| `ActivityAttribute` | Generates an [activity](https://developer.android.com/guide/topics/manifest/activity-element.html) XML fragment. |
| `ApplicationAttribute` | Generates an [application](https://developer.android.com/guide/topics/manifest/application-element.html) XML fragment. |
| `InstrumentationAttribute` | Generates an [instrumentation](https://developer.android.com/guide/topics/manifest/instrumentation-element.html) XML fragment. |
| `IntentFilterAttribute` | Generates an [intent-filter](https://developer.android.com/guide/topics/manifest/intent-filter-element.html) XML fragment. |
| `MetaDataAttribute` | Generates a [meta-data](https://developer.android.com/guide/topics/manifest/meta-data-element.html) XML fragment. |
| `PermissionAttribute` | Generates a [permission](https://developer.android.com/guide/topics/manifest/permission-element.html) XML fragment. |
| `PermissionGroupAttribute` | Generates a [permission-group](https://developer.android.com/guide/topics/manifest/permission-group-element.html) XML fragment. |
| `PermissionTreeAttribute` | Generates a [permission-tree](https://developer.android.com/guide/topics/manifest/permission-tree-element.html) XML fragment. |
| `ServiceAttribute` | Generates a [service](https://developer.android.com/guide/topics/manifest/service-element.html) XML fragment. |
| `UsesLibraryAttribute` | Generates a [uses-library](https://developer.android.com/guide/topics/manifest/uses-library-element.html) XML fragment. |
| `UsesPermissionAttribute` | Generates a [uses-permission](https://developer.android.com/guide/topics/manifest/uses-permission-element.html) XML fragment. |
| `BroadcastReceiverAttribute` | Generates a [receiver](https://developer.android.com/guide/topics/manifest/receiver-element.html) XML fragment. |
| `ContentProviderAttribute` | Generates a [provider](https://developer.android.com/guide/topics/manifest/provider-element.html) XML fragment. |
| `GrantUriPermissionAttribute` | Generates a [grant-uri-permission](https://developer.android.com/guide/topics/manifest/grant-uri-permission-element.html) XML fragment. |
