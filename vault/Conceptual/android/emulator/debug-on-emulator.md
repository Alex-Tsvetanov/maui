...
tags:
  ...
  - area/android
ms_date: "08/27/2024"
source: "https://learn.microsoft.com/dotnet/maui/android/emulator/debug-on-emulator?view=net-maui-10.0"
---

# Debug on the Android Emulator

The Android Emulator, installed as part of the **.NET Multi-Platform App UI development** workload, can be run in various configurations to simulate different Android devices. Each one of these configurations is created as a _virtual device_. In this article, you'll learn how to launch the emulator from Visual Studio and run your app in a virtual device. For more information about how to create and configure a virtual device, see [[device-manager|Managing virtual devices with the Android Device Manager]].
...
![](media/debug-on-emulator/win/vs-config-selection.png)
...
![](media/debug-on-emulator/emulator-running.png)
...
![](media/debug-on-emulator/loading-state.png)
...
For tips and workarounds for common emulator problems, see [[troubleshooting|Android Emulator Troubleshooting]].
