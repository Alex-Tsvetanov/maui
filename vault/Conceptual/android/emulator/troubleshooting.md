...
tags:
  ...
  - area/android
ms_date: "08/27/2024"
source: "https://learn.microsoft.com/dotnet/maui/android/emulator/troubleshooting?view=net-maui-10.0"
---
...
If the emulated Android device doesn't have Google Play Services or Google Play Store installed, you probably created a virtual device that excluded these packages. When you [[device-manager|create a virtual device]], be sure to select one or both of the following options:
...
![](media/troubleshooting/win/00-add-gps-w158.png)
...
![](media/troubleshooting/win/01-dev-mgr-warning-w158.png)
...
- Use a physical Android device connected via USB for debugging. For setup instructions, see [[setup|Set up Android device for debugging]].
