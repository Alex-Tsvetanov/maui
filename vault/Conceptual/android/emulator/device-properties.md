...
tags:
  ...
  - area/android
ms_date: "02/23/2022"
source: "https://learn.microsoft.com/dotnet/maui/android/emulator/device-properties?view=net-maui-10.0"
---
...
![](media/device-properties/win/new-device-editor.png)
...
- To change a string or integer property, double-click the current string or integer setting in the value column and enter a new value.
  ...
  ![](media/device-properties/win/integer-value.png)
