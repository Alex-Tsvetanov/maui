...
ms_date: "04/03/2026"
source: "https://learn.microsoft.com/dotnet/maui/developer-tools/devflow/network-profiling?view=net-maui-10.0"
---
...
Profiling data can be queried through the CLI or through [[mcp-server|MCP tools]] for AI-assisted analysis.
