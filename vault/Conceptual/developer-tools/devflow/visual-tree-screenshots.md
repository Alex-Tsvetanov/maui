...
ms_date: "04/03/2026"
source: "https://learn.microsoft.com/dotnet/maui/developer-tools/devflow/visual-tree-screenshots?view=net-maui-10.0"
---
...
- The DevFlow agent must be registered in your app. For setup instructions, see the [[devflow|DevFlow overview]].
...
CSS selectors are also used by the [[element-interaction|element interaction]] commands to identify target elements.
