...
tags:
  ...
  - area/user-interface
ms_date: "08/30/2024"
source: "https://learn.microsoft.com/dotnet/maui/user-interface/images/splashscreen?view=net-maui-10.0"
---
...
![](media/splashscreen/splashscreens.png)
...
At build time, the splash screen image is resized to the correct size for the target platform and device. The resized splash screen is then added to your app package. For information about disabling splash screen packaging, see [[troubleshooting#disable-splash-screen-packaging|Disable splash screen packaging]]. For information about generating a blank splash screen, see [[troubleshooting#generate-a-blank-splash-screen|Generate a blank splash screen]].
