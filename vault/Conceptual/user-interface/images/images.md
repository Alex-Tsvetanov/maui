...
tags:
  ...
  - area/user-interface
ms_date: "12/03/2024"
source: "https://learn.microsoft.com/dotnet/maui/user-interface/images/images?view=net-maui-10.0"
---
...
Image filenames must also be unique, otherwise a build error will occur. For more information, see [[troubleshooting|Duplicate image filename errors]].

At build time, images can be resized to the correct resolutions for the target platform and device. The resulting images are then added to your app package. For information about disabling image packaging, see [[troubleshooting#disable-image-packaging|Disable image packaging]].

For information about displaying images, see [[image|Image]].
...
Images can be displayed with the [[Image (Controls)|Image]] control. For more information, see [[image|Image]].
