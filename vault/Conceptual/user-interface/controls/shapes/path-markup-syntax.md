...
tags:
  ...
  - area/user-interface
ms_date: "08/30/2024"
source: "https://learn.microsoft.com/dotnet/maui/user-interface/controls/shapes/path-markup-syntax?view=net-maui-10.0"
---
...
- *fillRule* is an optional [[FillRule|FillRule]] that specifies whether the geometry should use the [[FillRule.EvenOdd|EvenOdd]] or [[FillRule.Nonzero|Nonzero]] fill rule. `F0` is used to specify the [[FillRule.EvenOdd|EvenOdd]] fill rule, while `F1` is used to specify the [[FillRule.Nonzero|Nonzero]] fill rule. For more information about fill rules, see [[fillrules|Fill rules]].
...
While path markup syntax is intended for consumption in XAML, it can be converted to a [[Geometry|Geometry]] object in code by invoking the `ConvertFromInvariantString` method in the [[PathGeometryConverter|PathGeometryConverter]] class:
...
For information about creating a straight line as a [[PathGeometry|PathGeometry]] object, see [[geometries#create-a-linesegment|Create a LineSegment]].
...
For information about creating an elliptical arc as a [[PathGeometry|PathGeometry]] object, see [[geometries#create-an-arcsegment|Create an ArcSegment]].
...
For information about creating a cubic Bezier curve as a [[PathGeometry|PathGeometry]] object, see [[geometries#create-a-beziersegment|Create a BezierSegment]].
...
For information about creating a quadratic Bezier curve as a [[PathGeometry|PathGeometry]] object, see [[geometries#create-a-quadraticbeziersegment|Create a QuadraticBezierSegment]].
