...
tags:
  ...
  - area/user-interface
ms_date: "09/30/2024"
source: "https://learn.microsoft.com/dotnet/maui/user-interface/tooltips?view=net-maui-10.0"
---

# Display tooltips

A .NET Multi-platform App UI (.NET MAUI) tooltip is a small rectangular popup that displays a brief description of a view's purpose, when the user rests the pointer on the [[controls#views|view]]. Tooltips display automatically, typically when the user hovers the pointer over the associated view:
...
For more information about attached properties, see [[attached-properties|Attached properties]].

By default, a tooltip is displayed centered above the pointer:

![](media/tooltips/tooltip.png)
