...
tags:
  ...
  - area/xaml
ms_date: "01/26/2022"
source: "https://learn.microsoft.com/dotnet/maui/xaml/namespaces/custom-namespace-schemas?view=net-maui-10.0"
---
...
For more information about XAML namespaces, see [[namespaces|XAML namespaces]].
...
> [!IMPORTANT]
> You should instruct the linker to preserve types in the assembly that are mapped through the custom namespace schema, or preserve the entire assembly. For more information, see [[linking#preserve-code|Preserve code]].
...
`CircleButton` instances can then be added to the [[ContentPage|ContentPage]] by declaring them with the `controls` namespace prefix.
...
![](media/custom-namespace-schemas/circle-buttons.png)
