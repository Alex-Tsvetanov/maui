...
tags:
  ...
  - area/xaml
ms_date: "03/24/2026"
source: "https://learn.microsoft.com/dotnet/maui/xaml/hot-reload?view=net-maui-10.0"
---
...
![](media/hot-reload/vs-options.png)
...
Disabling XAML compilation with `[XamlCompilation(XamlCompilationOptions.Skip)]` isn't supported and can cause issues with the Live Visual Tree. For more information about Live Visual Tree, see [[live-visual-tree|Inspect the visual tree of a .NET MAUI app]].
