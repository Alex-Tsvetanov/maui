...
tags:
  ...
  - area/xaml
ms_date: "02/28/2022"
source: "https://learn.microsoft.com/dotnet/maui/xaml/field-modifiers?view=net-maui-10.0"
---
...
> [!IMPORTANT]
> The `x:FieldModifier` attribute cannot be used to specify the access level of a .NET MAUI XAML class. For information about specifying the access level of a .NET MAUI XAML class, see [[class-modifiers|Class modifiers]].
