...
tags:
  ...
  - area/macios
ms_date: "10/23/2024"
source: "https://learn.microsoft.com/dotnet/maui/macios/interpreter?view=net-maui-10.0"
---
...
> [!WARNING]
> The interpreter isn't compatible with Native AOT deployment, and therefore the `$(UseInterpreter)` and `$(MtouchInterpreter)` MSBuild properties have no effect when using Native AOT.  For more information, see [[nativeaot|Native AOT deployment]].
