...
tags:
  ...
  - area/mac-catalyst
ms_date: "03/23/2023"
source: "https://learn.microsoft.com/dotnet/maui/mac-catalyst/includes/certificate-signing-request?view=net-maui-10.0"
---
...
1. In the **Certificate Assistant** dialog, choose the **Saved to disk** radio button and select **Continue**:
    ...
    ![](../deployment/media/certificate-assistant.png)
