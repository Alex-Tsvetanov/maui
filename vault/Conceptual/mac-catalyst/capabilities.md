...
tags:
  ...
  - area/mac-catalyst
ms_date: "08/28/2024"
source: "https://learn.microsoft.com/dotnet/maui/mac-catalyst/capabilities?view=net-maui-10.0"
---
...
- If you intend to distribute your app via the Mac App Store, see [[publish-app-store#create-a-distribution-certificate|Create a distribution certificate]] in [[publish-app-store|Publish a Mac Catalyst app for Mac App Store distribution]].
- If you intend to distribute your app outside the Mac App Store, see [[publish-outside-app-store#create-a-developer-id-application-certificate|Create a developer ID application certificate]] in [[publish-outside-app-store|Publish a Mac Catalyst app for distribution outside the Mac App Store]].
- If you intend to distribute your app to a limited number of users on registered devices, outside the Mac App Store, see [[publish-ad-hoc#create-a-development-certificate|Create a development certificate]] in [[publish-ad-hoc|Publish a Mac Catalyst app for ad-hoc distribution]].
...
- If you intend to distribute your app via the Mac App Store, see [[publish-app-store#create-a-provisioning-profile|Create a provisioning profile]] in [[publish-app-store|Publish a Mac Catalyst app for Mac App Store distribution]].
- If you intend to distribute your app outside the Mac App Store, see [[publish-outside-app-store#create-a-provisioning-profile|Create a provisioning profile]] in [[publish-outside-app-store|Publish a Mac Catalyst app for distribution outside the Mac App Store]].
- If you intend to distribute your app to a limited number of users on registered devices, outside the Mac App Store, see [[publish-ad-hoc#create-a-provisioning-profile|Create a provisioning profile]] in [[publish-ad-hoc|Publish a Mac Catalyst app for ad-hoc distribution]].
