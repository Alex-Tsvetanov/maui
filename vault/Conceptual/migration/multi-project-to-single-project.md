...
tags:
  ...
  - area/migration
ms_date: "08/29/2023"
source: "https://learn.microsoft.com/dotnet/maui/migration/multi-project-to-single-project?view=net-maui-10.0"
---
...
![](media/multi-project-to-single-project/create-maui-app.png)
...
Custom renderers can either be reused in a .NET MAUI app, or migrated to a .NET MAUI handler. For more information, see [[custom-renderers|Reuse custom renderers in .NET MAUI]] and [[renderer-to-handler|Migrate a Xamarin.Forms custom renderer to a .NET MAUI handler]].

Effects can be reused in a .NET MAUI app. For more information, see [[effects|Reuse effects]].
...
![](media/multi-project-to-single-project/platform-folders.png)

The folders for each platform contain platform-specific resources, and code that starts the app on each platform:

![](media/multi-project-to-single-project/platform-code.png)
...
![](media/multi-project-to-single-project/manifest.png)

At build time the shared app manifest data is merged with platform-specific data in the native app manifest file, to produce the manifest file for the app package. For more information, see [[visual-studio-properties#maui-shared|Project configuration in .NET MAUI - MAUI Shared]].
...
![](media/multi-project-to-single-project/resources.png)
...
For more information, see [[app-icons|Add an app icon to a .NET MAUI app project]].
...
For more information, see [[splashscreen|Add a splash screen to a .NET MAUI app project]].
...
For more information, see [[fonts|Fonts]].
...
For more information about using CSS files in a .NET MAUI app, see [[css|Style apps using Cascading Style Sheets]].
...
Localized images should have their build actions set to the build actions that are used in your Xamarin.Forms solution. For more information, see [[localization#localize-images|Localize images]].
...
For more information, see [[localization#localize-the-app-name|Localize the app name]]. For more information about .NET MAUI app localization, see [[localization|Localization]].
