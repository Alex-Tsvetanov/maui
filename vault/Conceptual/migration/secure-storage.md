...
tags:
  ...
  - area/migration
ms_date: "09/05/2023"
source: "https://learn.microsoft.com/dotnet/maui/migration/secure-storage?view=net-maui-10.0"
---
...
For more information about the `SecureStorage` class in Xamarin.Essentials, see [Xamarin.Essentials: Secure storage](/xamarin/essentials/secure-storage). For more information about the `SecureStorage` class in .NET MAUI, see [[secure-storage|Secure storage]].
...
You must also ensure that the *Entitlements.plist* file is set as the Custom Entitlements field in the Bundle Signing settings for your app. For more information, see [[entitlements|iOS Entitlements]].
