...
tags:
  ...
  - area/migration
ms_date: "07/17/2024"
source: "https://learn.microsoft.com/dotnet/maui/migration/push-notifications?view=net-maui-10.0"
---
...
For information on using [Azure Notification Hubs](/azure/notification-hubs/notification-hubs-push-notification-overview) to send push notifications to a .NET MAUI app targeting Android and iOS, see [[push-notifications|Send push notifications to .NET MAUI apps using Azure Notification Hubs via a backend service]].
