...
tags:
  ...
  - area/migration
ms_date: "10/06/2023"
source: "https://learn.microsoft.com/dotnet/maui/migration/version-tracking?view=net-maui-10.0"
---
...
For more information about the `VersionTracking` class in Xamarin.Essentials, see [Xamarin.Essentials: Version tracking](/xamarin/essentials/version-tracking). For more information about the [[VersionTracking|VersionTracking]] class in .NET MAUI, see [[version-tracking|Version tracking]].
...
Once the legacy version tracking data has been written to .NET MAUI preferences, it can be consumed by .NET MAUI's [[VersionTracking|VersionTracking]] class:
