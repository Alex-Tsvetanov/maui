...
tags:
  ...
  - area/migration
ms_date: "02/15/2023"
source: "https://learn.microsoft.com/dotnet/maui/migration/android-projects?view=net-maui-10.0"
---
...
To safely use this API, you can declare a higher `SupportedOSPlatformVersion` in your project or use the `IsAndroidVersionAtLeast%2A` API at runtime:
...
However, the `Mandroidl18n` MSBuild property isn't supported in .NET for Android apps. Instead, support is provided by the [System.TextEncoding.CodePages](https://www.nuget.org/packages/System.Text.Encoding.CodePages/) NuGet package. For more information, see `CodePagesEncodingProvider`.
