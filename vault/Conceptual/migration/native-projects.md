...
tags:
  ...
  - area/migration
ms_date: "02/15/2023"
source: "https://learn.microsoft.com/dotnet/maui/migration/native-projects?view=net-maui-10.0"
---
...
You'll also need to copy some project properties from your Xamarin native project to your new .NET project, for settings like conditional compilation arguments and code signing. Opening the projects side-by-side in separate Visual Studio instances will enable you to compare the project properties. Alternatively, you can migrate the settings by editing the new project file directly. For more information, see [[android-projects|Xamarin.Android project migration]] and [[apple-projects|Xamarin Apple project migration]].
...
For information about migrating Xamarin.Essentials code in a .NET for Android or .NET for iOS app, see [[native-essentials|Migrate Xamarin.Essentials code in .NET for Android and .NET for iOS apps]].
