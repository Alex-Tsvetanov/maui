...
tags:
  ...
  - area/whats-new
ms_date: "05/12/2026"
source: "https://learn.microsoft.com/dotnet/maui/whats-new/dotnet-11?view=net-maui-10.0"
---
...
Starting in .NET 11 Preview 4, compiled bindings with explicit sources defined inside a [[DataTemplate|DataTemplate]] now resolve correctly, fixing a regression that broke [[TapGestureRecognizer|TapGestureRecognizer]] bindings inside [[CollectionView|CollectionView]] items in .NET 10. For more information, see [GitHub PR #34447](https://github.com/dotnet/maui/pull/34447).
...
- `VisualElement.InvalidateStyle()` — forces a control to reapply its current [[Style|Style]], picking up any property changes made directly on the style object.
...
- [[ImageButton (Controls)|ImageButton]] — see [GitHub PR #33649](https://github.com/dotnet/maui/pull/33649).
- [[DatePicker (Controls)|DatePicker]] — see [GitHub PR #33651](https://github.com/dotnet/maui/pull/33651).
- [[Entry (Controls)|Entry]] — see [GitHub PR #33673](https://github.com/dotnet/maui/pull/33673).
- [[Slider (Controls)|Slider]] — see [GitHub PR #33603](https://github.com/dotnet/maui/pull/33603).
...
The [[Map (Maps)|Map]] control receives a significant set of enhancements in .NET 11 Preview 3:
...
For more information, see [[supported-platforms|Supported platforms]].
...
Starting in .NET 11 Preview 4, HTTP digest authentication is supported in `NSUrlSessionHandler`. For more information, see [dotnet/macios #25180](https://github.com/dotnet/macios/pull/25180).
