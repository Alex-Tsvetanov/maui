...
This repository hosts a **C++26 port of .NET MAUI**, under `port/`.
...
- [port/cpp/PROFILE.md](port/cpp/PROFILE.md) — the **C++26 language profile**: tooling, idiom map, naming, ownership doctrine.
