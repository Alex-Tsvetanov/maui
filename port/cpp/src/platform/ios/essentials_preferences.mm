// preferences - iOS (UIKit) platform partial: the shared NSUserDefaults implementation
// (essentials_user_defaults.hpp, the Preferences.ios.tvos.watchos.macos.cs twin). Compiled as
