...
namespace maui::core
{
    ...
    std::unique_ptr<time_picker_platform> time_picker_handler::create_platform_view()
    {
        ...
        // same trap progress_bar's styled ctor + the picker/editor partials hit). Construct with
        // defStyleAttr = 0 (no theme attr, what TextView(Context) does); fall back to the plain (Context)
