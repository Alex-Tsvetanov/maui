...
namespace maui::core
{
    ...
    // placeholder/placeholder_color/text/text_color/alignments/cursor/selection); MapBackground rides the
    // shared view_mapper, the Keyboard subsystem stays out of scope, and the iOS-only MapIsEnabled
    // override collapses into the shared is_enabled push.
    ...
    {
        static maui::core::command_mapper<i_editor, editor_handler> table{};
        return table;
    }
