...
namespace maui::graphics
{
    ...
    point_f::point_f(const vector2& v) : x(v.x), y(v.y)
    {
    }
    ...
    point_f point_f::transform_by(const matrix3x2& transform) const
    {
        return {vector2::transform(static_cast<vector2>(*this), transform)};
    }
    ...
    point_f::operator vector2() const
    {
        return {x, y};
    }
