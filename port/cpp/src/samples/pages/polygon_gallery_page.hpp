...
namespace maui::samples
{
    ...
    public:
        ...
        void attach_handlers(maui::hosting::maui_app& app)
        {
            ...
            gallery_attach_one(app, even_odd_label_, "even_odd_label_");
            gallery_attach_one(app, even_odd_, "even_odd_");
            gallery_attach_one(app, nonzero_label_, "nonzero_label_");
            gallery_attach_one(app, nonzero_, "nonzero_");
            gallery_attach_one(app, stack_, "stack_");
            gallery_attach_one(app, scroll_, "scroll_");
            gallery_attach_one(app, page_, "page_");

            gallery_rehost_layout(stack_);   // stack hosts every polygon + caption
