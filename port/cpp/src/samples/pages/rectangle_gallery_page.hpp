...
//   note: the C# <Style TargetType="Rectangle"> sets HorizontalOptions="Start" on every rectangle. The
...
//         still pins its own WidthRequest/HeightRequest, so the visual rectangle sizes are faithful;
//         only the in-stack horizontal alignment differs.
...
namespace maui::samples
{
    ...
    public:
        ...
        void attach_handlers(maui::hosting::maui_app& app)
        {
            ...
            gallery_attach_one(app, square_label_, "square_label_");
            gallery_attach_one(app, square_, "square_");
            gallery_attach_one(app, stroke_label_, "stroke_label_");
            gallery_attach_one(app, stroke_rect_, "stroke_rect_");
            gallery_attach_one(app, filled_stroke_rect_, "filled_stroke_rect_");
            gallery_attach_one(app, dash_label_, "dash_label_");
            gallery_attach_one(app, dash_rect_, "dash_rect_");
            gallery_attach_one(app, curved_label_, "curved_label_");
            gallery_attach_one(app, curved_rect_, "curved_rect_");
            gallery_attach_one(app, stack_, "stack_");
            gallery_attach_one(app, scroll_, "scroll_");
            gallery_attach_one(app, page_, "page_");

            gallery_rehost_layout(stack_);   // stack hosts every rectangle + caption
