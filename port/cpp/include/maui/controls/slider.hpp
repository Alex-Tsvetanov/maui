...
//
// Not ported (deferred, documented): ThumbImageSource (async image-service fetch) and the iOS
// UpdateOnTap platform configuration (see slider_handler.hpp).
...
{
    class slider : public view<maui::core::i_slider>
    {
    public:
        slider()
        {
