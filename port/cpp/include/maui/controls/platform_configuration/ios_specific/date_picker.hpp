#pragma once
// maui::controls::platform_configuration::ios_specific::date_picker
//   <=  Microsoft.Maui.Controls.PlatformConfiguration.iOSSpecific.DatePicker
// Ported from src/Controls/src/Core/PlatformConfiguration/iOSSpecific/DatePicker.cs. STORED knob (the C#
...
namespace maui::controls::platform_configuration::ios_specific::date_picker
{
    using forms_element = maui::controls::date_picker; // C# `using FormsElement = ...DatePicker`

    inline constexpr std::string_view update_mode_key = "ios.DatePicker.UpdateMode";
