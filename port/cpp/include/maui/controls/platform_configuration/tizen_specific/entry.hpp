#pragma once
// maui::controls::platform_configuration::tizen_specific::entry
//   <=  Microsoft.Maui.Controls.PlatformConfiguration.TizenSpecific.Entry
// Ported from src/Controls/src/Core/PlatformConfiguration/TizenSpecific/Entry.cs. STORED-INERT (no
...
namespace maui::controls::platform_configuration::tizen_specific::entry
{
    using forms_element = maui::controls::entry; // C# `using FormsElement = ...Entry`

    inline constexpr std::string_view font_weight_key = "tizen.Entry.FontWeight";
