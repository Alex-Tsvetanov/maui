...
namespace maui::core
{
    ...
    struct switch_platform : view_platform_base
    {
        ...
        // android.widget.Switch over JNI (defined in src/platform/android/switch_handler.cpp). Each
        ...
        // base mirror (WrapperView-only on Android). IsEnabled IS pushed (a Switch is interactive).
        void update_visibility(maui::core::visibility value) override;
        void update_opacity(double value) override;
        void update_is_enabled(bool value) override;
        void update_automation_id(std::string_view value) override;
