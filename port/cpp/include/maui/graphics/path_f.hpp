...
// System.Numerics interop: transform(const matrix3x2&) ports PathF.Transform(Matrix3x2) via the
// maui::graphics::matrix3x2 / vector2 stand-ins.
...
namespace maui::graphics
{
    ...
    public:
        ...
        // PathF.Transform(Matrix3x2): apply the affine matrix to every point in place (+ invalidate).
        void transform(const matrix3x2& transform);
