...
**Progress: 52 / 172 🟢 matched** · 120 🟡 minor · 0 🔴 diff · 0 ⬜ pending
...
| 17 | Image | 🟢<br>L:match<br>D:match | 🔴<br>L:diff<br>D:diff<br>_diff_<br><sub>gemini-3.1-flash-lite</sub> | <img src="csharp_ios_light/image.png" height="360"> | <img src="cpp_ios_light/image.png" height="360"> | <img src="csharp_ios_dark/image.png" height="360"> | <img src="cpp_ios_dark/image.png" height="360"> |
...
- **Both themes:** FIXED (was the sole 'diff'): file/font images now render aspect-fit and match the reference (FileSource purple submarine; Font Image Source glyphs). NOT a load failure — the bundled PNG decoded pixel-perfectly all along. iOS get_desired_size called plain [UIImageView sizeThatFits:], which ALWAYS returns the image's natural size ignoring the width constraint, so an AspectFit image was measured to its full 694pt natural height (submarine centered → pushed below the fold under its purple background_brush, read as 'blank purple'). Ported ImageViewExtensions.SizeThatFitsImage (aspect-aware fit) as ios_visual_ops::size_that_fits_image and routed get_desired_size through it. Verified iPhone-17 sim light+dark; 73/73 ios image tests pass; clang-tidy clean.
