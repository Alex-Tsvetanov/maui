...
| --: | --- | :---: | :---: | :---: | :---: | :---: | :---: |
| 1 | Label | 🟢<br>L:match<br>D:match | — | <img src="csharp_ios_light/label.png" height="360"> | <img src="cpp_ios_light/label.png" height="360"> | <img src="csharp_ios_dark/label.png" height="360"> | <img src="cpp_ios_dark/label.png" height="360"> |
| 2 | Button | 🟢<br>L:match<br>D:match | 🔴<br>L:diff<br>D:diff<br>_diff_ | <img src="csharp_ios_light/button.png" height="360"> | <img src="cpp_ios_light/button.png" height="360"> | <img src="csharp_ios_dark/button.png" height="360"> | <img src="cpp_ios_dark/button.png" height="360"> |
...
| 33 | Horizontal Stack | 🔴<br>L:diff<br>D:diff | 🔴<br>L:diff<br>D:diff<br>_diff_ | <img src="csharp_ios_light/horizontal_stack.png" height="360"> | <img src="cpp_ios_light/horizontal_stack.png" height="360"> | <img src="csharp_ios_dark/horizontal_stack.png" height="360"> | <img src="cpp_ios_dark/horizontal_stack.png" height="360"> |
...
| 66 | Clip | 🟡<br>L:minor<br>D:minor | — | <img src="csharp_ios_light/clip.png" height="360"> | <img src="cpp_ios_light/clip.png" height="360"> | <img src="csharp_ios_dark/clip.png" height="360"> | <img src="cpp_ios_dark/clip.png" height="360"> |
...
| 112 | Chat Example | 🔴<br>L:minor<br>D:diff | — | <img src="csharp_ios_light/chat_example.png" height="360"> | <img src="cpp_ios_light/chat_example.png" height="360"> | <img src="csharp_ios_dark/chat_example.png" height="360"> | <img src="cpp_ios_dark/chat_example.png" height="360"> |
...
### 112. Chat Example — 🔴 (L:minor / D:diff)
...
- **Dark:** Content-width per-sender alignment FIXED, same as light (collection_view_handler.mm MauiCollectionViewCell now measures + arranges non-Fill cell content content-width via the cross-platform arrange instead of stretching it): the green (local) bubble is content-width RIGHT-aligned and the blue (remote) bubble content-width LEFT-aligned, matching MAUI's per-sender pills (bubble geometry + pastel fills + margins now match). Two residuals remain: (1) the bubble text renders light instead of MAUI's explicit TextColor=Black — a SEPARATE, pre-existing label-text-color-under-dark-appearance issue (the explicit black is not honored in dark mode; visible on the prior capture too, unrelated to this cell-sizing fix); (2) the single-root templated cell can't carry the Border RoundRectangle StrokeShape, so the bubbles are square-cornered vs MAUI's CornerRadius=12 (documented single-root reduction). The headline full-width-bar bug is resolved.
