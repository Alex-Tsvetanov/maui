...
**Run it:** `MAUI_SAMPLE_PAGE=basic_swipe ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=basic_swipe xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
