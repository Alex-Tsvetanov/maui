...
**Run it:** `MAUI_SAMPLE_PAGE=border_playground ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=border_playground xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
