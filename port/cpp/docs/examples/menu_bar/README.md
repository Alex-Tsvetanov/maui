...
**Run it:** `MAUI_SAMPLE_PAGE=menu_bar ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=menu_bar xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
