...
**Run it:** `MAUI_SAMPLE_PAGE=application_control ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=application_control xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
