...
**Run it:** `MAUI_SAMPLE_PAGE=input_transparent ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=input_transparent xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
