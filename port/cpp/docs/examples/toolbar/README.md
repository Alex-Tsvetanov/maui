...
**Run it:** `MAUI_SAMPLE_PAGE=toolbar ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=toolbar xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
