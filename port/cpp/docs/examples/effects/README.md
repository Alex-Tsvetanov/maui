...
**Run it:** `MAUI_SAMPLE_PAGE=effects ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=effects xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
