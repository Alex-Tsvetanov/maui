...
**Run it:** `MAUI_SAMPLE_PAGE=drag_drop ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=drag_drop xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
