...
**Run it:** `MAUI_SAMPLE_PAGE=clip_views ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=clip_views xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
