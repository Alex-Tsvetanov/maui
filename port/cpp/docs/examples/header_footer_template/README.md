...
**Run it:** `MAUI_SAMPLE_PAGE=header_footer_template ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=header_footer_template xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
