...
**Run it:** `MAUI_SAMPLE_PAGE=ios_entry ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ios_entry xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
