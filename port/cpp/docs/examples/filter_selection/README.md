...
**Run it:** `MAUI_SAMPLE_PAGE=filter_selection ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=filter_selection xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
