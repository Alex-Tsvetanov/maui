...
**Run it:** `MAUI_SAMPLE_PAGE=radio_template_from_style ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=radio_template_from_style xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
