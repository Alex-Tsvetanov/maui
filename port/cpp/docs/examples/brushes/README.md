...
**Run it:** `MAUI_SAMPLE_PAGE=brushes ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=brushes xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
