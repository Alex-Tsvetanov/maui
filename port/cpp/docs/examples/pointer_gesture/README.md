...
**Run it:** `MAUI_SAMPLE_PAGE=pointer_gesture ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=pointer_gesture xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
