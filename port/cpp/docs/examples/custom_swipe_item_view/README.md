...
**Run it:** `MAUI_SAMPLE_PAGE=custom_swipe_item_view ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=custom_swipe_item_view xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
