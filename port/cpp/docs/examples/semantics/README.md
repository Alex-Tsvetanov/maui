...
**Run it:** `MAUI_SAMPLE_PAGE=semantics ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=semantics xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
