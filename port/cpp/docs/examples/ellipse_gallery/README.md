...
**Run it:** `MAUI_SAMPLE_PAGE=ellipse_gallery ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ellipse_gallery xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
