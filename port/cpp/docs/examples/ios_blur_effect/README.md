...
**Run it:** `MAUI_SAMPLE_PAGE=ios_blur_effect ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ios_blur_effect xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
