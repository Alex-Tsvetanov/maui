...
**Run it:** `MAUI_SAMPLE_PAGE=swipe_view_margin ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=swipe_view_margin xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
