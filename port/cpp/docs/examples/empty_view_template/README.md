...
**Run it:** `MAUI_SAMPLE_PAGE=empty_view_template ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=empty_view_template xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
