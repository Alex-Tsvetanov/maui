...
**Run it:** `MAUI_SAMPLE_PAGE=invalidate_brush ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=invalidate_brush xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
