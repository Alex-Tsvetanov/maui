...
**Run it:** `MAUI_SAMPLE_PAGE=pan_gesture_events ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=pan_gesture_events xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
