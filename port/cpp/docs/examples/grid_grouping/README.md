...
**Run it:** `MAUI_SAMPLE_PAGE=grid_grouping ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=grid_grouping xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
