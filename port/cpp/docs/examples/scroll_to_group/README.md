...
**Run it:** `MAUI_SAMPLE_PAGE=scroll_to_group ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=scroll_to_group xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
