...
**Run it:** `MAUI_SAMPLE_PAGE=border_stroke ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=border_stroke xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
