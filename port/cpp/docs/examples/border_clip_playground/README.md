...
**Run it:** `MAUI_SAMPLE_PAGE=border_clip_playground ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=border_clip_playground xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
