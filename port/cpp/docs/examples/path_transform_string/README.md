...
**Run it:** `MAUI_SAMPLE_PAGE=path_transform_string ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=path_transform_string xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
