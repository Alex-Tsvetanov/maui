...
**Run it:** `MAUI_SAMPLE_PAGE=preselected_items ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=preselected_items xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
