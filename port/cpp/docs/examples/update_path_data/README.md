...
**Run it:** `MAUI_SAMPLE_PAGE=update_path_data ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=update_path_data xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
