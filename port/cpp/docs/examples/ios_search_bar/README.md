...
**Run it:** `MAUI_SAMPLE_PAGE=ios_search_bar ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ios_search_bar xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
