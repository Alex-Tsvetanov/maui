...
**Run it:** `MAUI_SAMPLE_PAGE=selection_synchronization ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=selection_synchronization xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
