...
**Run it:** `MAUI_SAMPLE_PAGE=swipe_item_position ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=swipe_item_position xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
