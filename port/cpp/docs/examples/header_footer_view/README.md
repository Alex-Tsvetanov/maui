...
**Run it:** `MAUI_SAMPLE_PAGE=header_footer_view ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=header_footer_view xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
