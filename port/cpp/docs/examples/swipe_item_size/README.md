...
**Run it:** `MAUI_SAMPLE_PAGE=swipe_item_size ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=swipe_item_size xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
