...
**Run it:** `MAUI_SAMPLE_PAGE=ios_date_picker ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ios_date_picker xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
