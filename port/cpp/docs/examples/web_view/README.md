...
`EvaluateJavaScriptAsync` round-trip. Source: [`web_view_page.hpp`](../../../src/samples/pages/web_view_page.hpp).
...
**Run it:**
- macOS — `MAUI_SAMPLE_PAGE=web_view ./build/apple/maui_macos_gallery`
