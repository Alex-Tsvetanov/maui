...
**Run it:** `MAUI_SAMPLE_PAGE=line_gallery ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=line_gallery xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
