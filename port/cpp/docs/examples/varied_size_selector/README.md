...
**Run it:** `MAUI_SAMPLE_PAGE=varied_size_selector ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=varied_size_selector xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
