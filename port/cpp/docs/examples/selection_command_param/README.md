...
**Run it:** `MAUI_SAMPLE_PAGE=selection_command_param ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=selection_command_param xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
