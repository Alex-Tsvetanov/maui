...
**Run it:** `MAUI_SAMPLE_PAGE=custom_layout ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=custom_layout xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
