...
**Run it:** `MAUI_SAMPLE_PAGE=header_footer_grid ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=header_footer_grid xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
