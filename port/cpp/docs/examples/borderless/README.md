...
**Run it:** `MAUI_SAMPLE_PAGE=borderless ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=borderless xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
