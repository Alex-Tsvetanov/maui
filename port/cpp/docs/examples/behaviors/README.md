...
**Run it:** `MAUI_SAMPLE_PAGE=behaviors ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=behaviors xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
