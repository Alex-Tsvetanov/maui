...
**Run it:** `MAUI_SAMPLE_PAGE=swipe_gesture ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=swipe_gesture xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
