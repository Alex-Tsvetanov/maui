...
**Run it:** `MAUI_SAMPLE_PAGE=focus ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=focus xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
