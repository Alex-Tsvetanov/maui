...
**Run it:** `MAUI_SAMPLE_PAGE=some_empty_groups ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=some_empty_groups xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
