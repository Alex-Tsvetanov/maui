...
**Run it:** `MAUI_SAMPLE_PAGE=ios_picker ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=ios_picker xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
