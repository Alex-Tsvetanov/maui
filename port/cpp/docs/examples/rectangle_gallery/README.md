...
**Run it:** `MAUI_SAMPLE_PAGE=rectangle_gallery ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=rectangle_gallery xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
