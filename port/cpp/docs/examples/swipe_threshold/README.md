...
**Run it:** `MAUI_SAMPLE_PAGE=swipe_threshold ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=swipe_threshold xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
