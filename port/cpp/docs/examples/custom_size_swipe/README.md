...
**Run it:** `MAUI_SAMPLE_PAGE=custom_size_swipe ./examples/build/gallery/gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=custom_size_swipe xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
