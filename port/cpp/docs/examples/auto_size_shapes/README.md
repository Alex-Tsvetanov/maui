...
**Run it:** `MAUI_SAMPLE_PAGE=auto_size_shapes ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=auto_size_shapes xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
