...
**Run it:** `MAUI_SAMPLE_PAGE=clip_gallery ./build/apple/maui_macos_gallery` (macOS) · `SIMCTL_CHILD_MAUI_SAMPLE_PAGE=clip_gallery xcrun simctl launch booted dev.maui-cpp.ios-gallery` (iOS)
