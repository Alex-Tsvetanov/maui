// single_bound_selection.xaml.cpp — implements examples::Views::single_bound_selection_page() (declared in
// single_bound_selection.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/single_bound_selection.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.SingleBoundSelectionPage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char single_bound_selection_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/single_bound_selection.xaml"
    };
    constexpr maui::fixed_string single_bound_selection_xaml{single_bound_selection_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(single_bound_selection_xaml);
    ...
    static_assert(bytes_contain(single_bound_selection_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(single_bound_selection_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.SingleBoundSelectionPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> single_bound_selection_page(
        const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, single_bound_selection_xaml>(options);
    }
} // namespace examples::Views
