...
// port/maui-reference/pages/empty_view_swap.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.EmptyViewSwapPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/empty_view_swap.xaml"
    };
    constexpr maui::fixed_string empty_view_swap_xaml{empty_view_swap_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(empty_view_swap_xaml);
    ...
    static_assert(bytes_contain(empty_view_swap_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(empty_view_swap_xaml_bytes, "x:Class=\"MauiReference.Pages.EmptyViewSwapPage\""));
} // namespace
