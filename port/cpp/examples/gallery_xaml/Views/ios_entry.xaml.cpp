...
// port/maui-reference/pages/ios_entry.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.IosEntryPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/ios_entry.xaml"
    };
    constexpr maui::fixed_string ios_entry_xaml{ios_entry_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(ios_entry_xaml);
    ...
    static_assert(bytes_contain(ios_entry_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(ios_entry_xaml_bytes, "x:Class=\"MauiReference.Pages.IosEntryPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> ios_entry_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, ios_entry_xaml>(options);
    }
} // namespace examples::Views
