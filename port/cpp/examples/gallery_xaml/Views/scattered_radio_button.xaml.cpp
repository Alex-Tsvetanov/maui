...
// port/maui-reference/pages/scattered_radio_button.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.ScatteredRadioButtonPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/scattered_radio_button.xaml"
    };
    constexpr maui::fixed_string scattered_radio_button_xaml{scattered_radio_button_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(scattered_radio_button_xaml);
    ...
    static_assert(bytes_contain(scattered_radio_button_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(scattered_radio_button_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.ScatteredRadioButtonPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, scattered_radio_button_xaml>(options);
    }
} // namespace examples::Views
