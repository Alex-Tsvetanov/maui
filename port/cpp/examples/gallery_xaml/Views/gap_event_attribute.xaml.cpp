// gap_event_attribute.xaml.cpp — implements examples::Views::gap_event_attribute_page() (declared in
// gap_event_attribute.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/gap_event_attribute.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.GapEventAttributePage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char gap_event_attribute_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/gap_event_attribute.xaml"
    ...
    static_assert(bytes_contain(gap_event_attribute_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(gap_event_attribute_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.GapEventAttributePage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> gap_event_attribute_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, gap_event_attribute_xaml>(options);
    }
} // namespace examples::Views
