// horizontal_stack.xaml.cpp — implements examples::Views::horizontal_stack_page() (declared in
// horizontal_stack.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/horizontal_stack.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.HorizontalStackPage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char horizontal_stack_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/horizontal_stack.xaml"
    };
    constexpr maui::fixed_string horizontal_stack_xaml{horizontal_stack_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(horizontal_stack_xaml);
    ...
    static_assert(bytes_contain(horizontal_stack_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(horizontal_stack_xaml_bytes, "x:Class=\"MauiReference.Pages.HorizontalStackPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> horizontal_stack_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, horizontal_stack_xaml>(options);
    }
} // namespace examples::Views
