...
// port/maui-reference/pages/radio_button_content.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.RadioButtonContentPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/radio_button_content.xaml"
    };
    constexpr maui::fixed_string radio_button_content_xaml{radio_button_content_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(radio_button_content_xaml);
    ...
    static_assert(bytes_contain(radio_button_content_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(radio_button_content_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.RadioButtonContentPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, radio_button_content_xaml>(options);
    }
} // namespace examples::Views
