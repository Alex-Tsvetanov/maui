...
{
    std::unique_ptr<maui::controls::content_page> scroll_mode_test_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, scroll_mode_test_xaml>(options);
    }
} // namespace examples::Views
