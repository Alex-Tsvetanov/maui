...
// port/maui-reference/pages/path_transform_string.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.PathTransformStringPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/path_transform_string.xaml"
    };
    constexpr maui::fixed_string path_transform_string_xaml{path_transform_string_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(path_transform_string_xaml);
    ...
    static_assert(bytes_contain(path_transform_string_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(path_transform_string_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.PathTransformStringPage\""));
} // namespace
