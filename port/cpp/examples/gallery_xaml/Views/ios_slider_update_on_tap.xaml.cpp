...
// port/maui-reference/pages/ios_slider_update_on_tap.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.IosSliderUpdateOnTapPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/ios_slider_update_on_tap.xaml"
    ...
    static_assert(bytes_contain(ios_slider_update_on_tap_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(ios_slider_update_on_tap_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.IosSliderUpdateOnTapPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, ios_slider_update_on_tap_xaml>(options);
    }
} // namespace examples::Views
