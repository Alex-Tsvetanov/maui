...
// port/maui-reference/pages/varied_size_selector.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.VariedSizeSelectorPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/varied_size_selector.xaml"
    };
    constexpr maui::fixed_string varied_size_selector_xaml{varied_size_selector_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(varied_size_selector_xaml);
    ...
    static_assert(bytes_contain(varied_size_selector_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(varied_size_selector_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.VariedSizeSelectorPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, varied_size_selector_xaml>(options);
    }
} // namespace examples::Views
