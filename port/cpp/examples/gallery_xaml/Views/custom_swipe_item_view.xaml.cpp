// custom_swipe_item_view.xaml.cpp — implements examples::Views::custom_swipe_item_view_page() (declared in
// custom_swipe_item_view.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/custom_swipe_item_view.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.CustomSwipeItemViewPage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char custom_swipe_item_view_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/custom_swipe_item_view.xaml"
    };
    constexpr maui::fixed_string custom_swipe_item_view_xaml{custom_swipe_item_view_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(custom_swipe_item_view_xaml);
    ...
    static_assert(bytes_contain(custom_swipe_item_view_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(custom_swipe_item_view_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.CustomSwipeItemViewPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> custom_swipe_item_view_page(
        const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, custom_swipe_item_view_xaml>(options);
    }
} // namespace examples::Views
