...
// port/maui-reference/pages/measure_first_strategy.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.MeasureFirstStrategyPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/measure_first_strategy.xaml"
    };
    ...
    static_assert(bytes_contain(measure_first_strategy_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(measure_first_strategy_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.MeasureFirstStrategyPage\""));
} // namespace
...
namespace examples::Views
{
    ...
    {
        auto page = maui::build_page<maui::no_view_model, measure_first_strategy_xaml>(options);
