...
// port/maui-reference/pages/invalidate_shadow_host.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.InvalidateShadowHostPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/invalidate_shadow_host.xaml"
    };
    constexpr maui::fixed_string invalidate_shadow_host_xaml{invalidate_shadow_host_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(invalidate_shadow_host_xaml);
    ...
    static_assert(bytes_contain(invalidate_shadow_host_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(invalidate_shadow_host_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.InvalidateShadowHostPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, invalidate_shadow_host_xaml>(options);
    }
} // namespace examples::Views
