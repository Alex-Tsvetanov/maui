...
// port/maui-reference/pages/grouping_no_templates.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.GroupingNoTemplatesPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/grouping_no_templates.xaml"
    };
    ...
    static_assert(bytes_contain(grouping_no_templates_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(grouping_no_templates_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.GroupingNoTemplatesPage\""));
} // namespace
...
namespace examples::Views
{
    ...
    {
        auto page = maui::build_page<maui::no_view_model, grouping_no_templates_xaml>(options);
        ...
        {
            list->set_items_source(examples::ViewModels::super_teams_text());
        }
