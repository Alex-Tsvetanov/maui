// swipe_view_shadow.xaml.cpp — implements examples::Views::swipe_view_shadow_page() (declared in
// swipe_view_shadow.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/swipe_view_shadow.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.SwipeViewShadowPage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char swipe_view_shadow_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/swipe_view_shadow.xaml"
    };
    constexpr maui::fixed_string swipe_view_shadow_xaml{swipe_view_shadow_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(swipe_view_shadow_xaml);
    ...
    static_assert(bytes_contain(swipe_view_shadow_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(swipe_view_shadow_xaml_bytes, "x:Class=\"MauiReference.Pages.SwipeViewShadowPage\""));
} // namespace
