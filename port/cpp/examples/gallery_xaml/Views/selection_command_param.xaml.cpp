...
// port/maui-reference/pages/selection_command_param.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.SelectionCommandParamPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/selection_command_param.xaml"
    };
    constexpr maui::fixed_string selection_command_param_xaml{selection_command_param_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(selection_command_param_xaml);
    ...
    static_assert(bytes_contain(selection_command_param_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(selection_command_param_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.SelectionCommandParamPage\""));
} // namespace
...
namespace examples::Views
{
        ...
        const maui::xaml::xaml_load_options& options)
    {
        ...
        return maui::build_page<maui::no_view_model, selection_command_param_xaml>(options);
    }
} // namespace examples::Views
