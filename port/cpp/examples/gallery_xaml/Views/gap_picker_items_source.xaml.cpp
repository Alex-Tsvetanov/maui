// gap_picker_items_source.xaml.cpp — implements examples::Views::gap_picker_items_source_page() (declared in
// gap_picker_items_source.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/gap_picker_items_source.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.GapPickerItemsSourcePage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char gap_picker_items_source_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/gap_picker_items_source.xaml"
    };
    constexpr maui::fixed_string gap_picker_items_source_xaml{gap_picker_items_source_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(gap_picker_items_source_xaml);
    ...
    static_assert(bytes_contain(gap_picker_items_source_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(gap_picker_items_source_xaml_bytes,
                                "x:Class=\"MauiReference.Pages.GapPickerItemsSourcePage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> gap_picker_items_source_page(
        const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, gap_picker_items_source_xaml>(options);
    }
} // namespace examples::Views
