// chat_example.xaml.cpp — implements examples::Views::chat_example_page() (declared in chat_example.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/chat_example.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.ChatExamplePage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char chat_example_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/chat_example.xaml"
    };
    constexpr maui::fixed_string chat_example_xaml{chat_example_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(chat_example_xaml);
    ...
    static_assert(bytes_contain(chat_example_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(chat_example_xaml_bytes, "x:Class=\"MauiReference.Pages.ChatExamplePage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> chat_example_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, chat_example_xaml>(options);
    }
} // namespace examples::Views
