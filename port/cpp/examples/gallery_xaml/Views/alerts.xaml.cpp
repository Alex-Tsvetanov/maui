...
// port/maui-reference/pages/alerts.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.AlertsPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/alerts.xaml"
    };
    constexpr maui::fixed_string alerts_xaml{alerts_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(alerts_xaml);
    ...
    static_assert(bytes_contain(alerts_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(alerts_xaml_bytes, "x:Class=\"MauiReference.Pages.AlertsPage\""));
} // namespace
