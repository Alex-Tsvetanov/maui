...
// port/maui-reference/pages/rectangle_gallery.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.RectangleGalleryPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/rectangle_gallery.xaml"
    };
    constexpr maui::fixed_string rectangle_gallery_xaml{rectangle_gallery_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(rectangle_gallery_xaml);
    ...
    static_assert(bytes_contain(rectangle_gallery_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(rectangle_gallery_xaml_bytes, "x:Class=\"MauiReference.Pages.RectangleGalleryPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> rectangle_gallery_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, rectangle_gallery_xaml>(options);
    }
} // namespace examples::Views
