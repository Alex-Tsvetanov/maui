...
#embed "../../../../maui-reference/pages/polygon_gallery.xaml"
    ...
    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(polygon_gallery_xaml);
...
{
    std::unique_ptr<maui::controls::content_page> polygon_gallery_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, polygon_gallery_xaml>(options);
    }
} // namespace examples::Views
