// input_controls.xaml.cpp — implements examples::Views::input_controls_page() (declared in input_controls.xaml.hpp).
//
// This TU OWNS the compile-time XAML: the COMPILER embeds the CANONICAL SHARED page
// port/maui-reference/pages/input_controls.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.InputControlsPage) — and build_page hydrates it through the runtime
...
namespace
{
    ...
    constexpr unsigned char input_controls_xaml_bytes[] = {
#embed "../../../../maui-reference/pages/input_controls.xaml"
    };
    constexpr maui::fixed_string input_controls_xaml{input_controls_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(input_controls_xaml);
    ...
    static_assert(bytes_contain(input_controls_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(input_controls_xaml_bytes, "x:Class=\"MauiReference.Pages.InputControlsPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> input_controls_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, input_controls_xaml>(options);
    }
} // namespace examples::Views
