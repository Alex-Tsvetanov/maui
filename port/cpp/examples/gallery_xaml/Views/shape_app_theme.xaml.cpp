...
// port/maui-reference/pages/shape_app_theme.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.ShapeAppThemePage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/shape_app_theme.xaml"
    };
    constexpr maui::fixed_string shape_app_theme_xaml{shape_app_theme_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(shape_app_theme_xaml);
    ...
    static_assert(bytes_contain(shape_app_theme_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(shape_app_theme_xaml_bytes, "x:Class=\"MauiReference.Pages.ShapeAppThemePage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> shape_app_theme_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, shape_app_theme_xaml>(options);
    }
} // namespace examples::Views
