...
// port/maui-reference/pages/value_controls.xaml — the exact same bytes real .NET MAUI compiles via XamlC +
// code-behind (MauiReference.Pages.ValueControlsPage) — and build_page hydrates it through the runtime
...
#embed "../../../../maui-reference/pages/value_controls.xaml"
    };
    constexpr maui::fixed_string value_controls_xaml{value_controls_xaml_bytes};

    MAUI_XAML_REJECT_EVENT_ATTRIBUTES(value_controls_xaml);
    ...
    static_assert(bytes_contain(value_controls_xaml_bytes, "<ContentPage"));
    static_assert(bytes_contain(value_controls_xaml_bytes, "x:Class=\"MauiReference.Pages.ValueControlsPage\""));
} // namespace

namespace examples::Views
{
    std::unique_ptr<maui::controls::content_page> value_controls_page(const maui::xaml::xaml_load_options& options)
    {
        // unique_ptr<page_impl<no_view_model>> upcasts to unique_ptr<content_page> on return.
        return maui::build_page<maui::no_view_model, value_controls_xaml>(options);
    }
} // namespace examples::Views
