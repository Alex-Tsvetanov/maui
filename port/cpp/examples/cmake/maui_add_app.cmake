...
#
# Signature:
#   maui_add_app(<name> SOURCES <src>... [RESOURCES <file>...])
#     SOURCES   — the example's pure-C++ translation units (required; one defines main via maui_main.hpp).
#     RESOURCES — optional asset files copied next to the binary (macOS/headless) or into the .app
#                 bundle root (iOS), the same flat layout the framework's gallery POST_BUILD step uses.
...
function(maui_add_app name)
  cmake_parse_arguments(ARG "" "" "SOURCES;RESOURCES" ${ARGN})
  if(NOT ARG_SOURCES)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
    ...
    set_target_properties(${name} PROPERTIES
      MACOSX_BUNDLE TRUE
      MACOSX_BUNDLE_INFO_PLIST "${MAUI_EXAMPLE_IOS_PLIST_IN}"
      MACOSX_BUNDLE_BUNDLE_NAME "${name}"
      MACOSX_BUNDLE_GUI_IDENTIFIER "dev.maui-cpp.examples.${name}"
